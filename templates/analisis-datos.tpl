...
<div class="container">		
	<div class="row-fluid">
    	<div class="span9">
            <!-- Our Services -->
            <div class="row-fluid">
                <div class="headline"><h3>Analisis de Datos</h3></div>
                <div class="row-fluid margin-bottom-40">
                    <div class="span12">
                        <h4><a href="#"></a></h4>
                        <p>Big Data requiere una gran cantidad de recursos, sin embargo los beneficios de esta se ven producidos en la misma cantidad. Al desplegar Hadoop MapReduce una compania puede generar reportes, analizar datos, observar las tendencias del negocio y mucho mas. Demiops provee una manera sencilla para utilizar y procesar Big Data utilizando DData, el cual le permitira tener un cluster MapReduce listo para ingerir datos en minutos.</p>
                    </div>
                </div><!--/welcome-block-->
            </div><!--/row-fluid-->        
