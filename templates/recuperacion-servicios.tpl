...
<div class="container">		
	<div class="row-fluid">
    	<div class="span9">
            <!-- Our Services -->
            <div class="row-fluid">
                <div class="headline"><h3>Recuperacion de Servicios</h3></div>
                <div class="row-fluid margin-bottom-40">
                    <div class="span12">
                        <h4><a href="#"></a></h4>
                        <p>Restaurar el servicio se vuelve parte fundamental de cualquier negocio que esta basado en TI. Tener la hablidad de mover su infraestructura entre diferentes proveedores de cloud o crear una infraestructura de respaldo en su propia cloud privada, permitira a su negocio darle la satifaccion y la seguridad a sus clientes de que sus sistemas estaran 99.999% disponibles y accesibles. </p>
                    </div>
                </div><!--/welcome-block-->
            </div><!--/row-fluid-->        
