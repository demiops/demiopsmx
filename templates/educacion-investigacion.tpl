...
<div class="container">		
	<div class="row-fluid">
    	<div class="span9">
            <!-- Our Services -->
            <div class="row-fluid">
                <div class="headline"><h3>Educacion e Investigacion</h3></div>
                <div class="row-fluid margin-bottom-40">
                    <div class="span12">
                        <h4><a href="#"></a></h4>
                        <p>Cloud privadas se estan convirtiendo en la opcion por default para el sector de Educacion e Investigacion, la mayoria de las cloud privadas pueden ser instaladas en equipo realmente barato el cual se convierte en un buen comienzo para las universidades y escuales las cuales estan buscando preparar a sus estudiantes en el campo de TI al mismo tiempo que proveen a sus investigadores con mas recursos de computo. Clusters de alto rendimiento y analisis masivo de datos para la creacion de modelos, proyeciones y predicciones se estan volviendo comunes y un mercado popular para las cloud privadas. Algunos proveedores de cloud publicas tienen opciones de vms que incluyen GPU's los cuales son perfectos para un alto numero de operaciones matematicas, especialmente para el modelo de escenarios y patrones. </p>
                    </div>
                </div><!--/welcome-block-->
            </div><!--/row-fluid-->        
