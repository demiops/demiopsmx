...
<div class="container">		
	<div class="row-fluid">
    	<div class="span9">
            <!-- Our Services -->
            <div class="row-fluid">
                <div class="headline"><h3>Plataforma como Servicio</h3></div>
                <div class="row-fluid margin-bottom-40">
                    <div class="span12">
                        <h4><a href="#"></a></h4>
                        <p>Plataforma como servicio (PaaS) ofrece servicios de ejecución de aplicaciones, como la aplicación en tiempo de ejecución, el almacenamiento y la integración, para aplicaciones escritas para un marco de desarrollo pre-especificado. PaaS proporciona un enfoque eficaz y ágil para operar aplicaciones de escala horizontal de una manera predecible y rentable. <br><br>Los niveles de servicio y los riesgos operativos son compartidos por el consumidor debe asumir la responsabilidad de la estabilidad, el cumplimiento de arquitectura, y las operaciones generales de la aplicación, mientras que el proveedor entrega la capacidad de la plataforma (incluyendo la infraestructura y las funciones operativas) a un nivel de servicio predecible y rentable.</p>
                    </div>
                </div><!--/welcome-block-->
            </div><!--/row-fluid-->        
