...
<div class="container">		
	<div class="row-fluid">
    	<div class="span9">
            <!-- Our Services -->
            <div class="row-fluid">
                <div class="headline"><h3>Gestion de la Nube (Cloud)</h3></div>
                <div class="row-fluid margin-bottom-40">
                    <div class="span12">
                        <h4><a href="#"></a></h4>
                        <p>Gestión de la nube significa que el software y las tecnologías diseñadas para el manejo y visualización de aplicaciones, datos y servicios que residen en la nube. Herramientas de gestión de la nube ayudan a asegurar que los recursos de computación basados en la nube de la compañía están trabajando de manera óptima e interactuar correctamente con los usuarios y otros servicios.<br><br>
Estrategias de gestión de la nube <br><br>
Estrategias de gestión de la nube suelen incluir muchas tareas, incluyendo la supervisión del rendimiento (tiempo de respuesta, latencia, tiempo de actividad, etc), la seguridad y la auditoría y la gestión del cumplimiento, e iniciar y supervisar la recuperación de desastres y planes de contingencia.<br><br>
Con el cloud computing crece más complejo y una gran variedad de sistemas e infraestructuras ya en uso basados en la nube privadas, híbridas y públicas, colección de herramientas de gestión de la nube de una empresa tiene que ser tan flexible y escalable como su estrategia de cloud computing.</p>
                    </div>
                </div><!--/welcome-block-->
            </div><!--/row-fluid-->        
