...
<div class="container">		
	<div class="row-fluid">
    	<div class="span9">
            <!-- Our Services -->
            <div class="row-fluid">
                <div class="headline"><h3>Infraestructura como Servicio</h3></div>
                <div class="row-fluid margin-bottom-40">
                    <div class="span12">
                        <h4><a href="#"></a></h4>
                        <p>Infraestructura como servicio (IaaS) resúmenes hardware (servidores, almacenamiento e infraestructura de red) en una piscina de computación, almacenamiento, y capacidades de conectividad que se entregan los servicios por un costo basado en el uso (medido). Su objetivo es proporcionar un entorno de trabajo flexible y estándar y virtualizado que puede convertirse en una base para PaaS y SaaS.<br><br>
IaaS se ve generalmente para proporcionar un servidor virtual estandarizado. El consumidor asume la responsabilidad para la configuración y el funcionamiento del sistema operativo invitado (OS), software y base de datos (DB). Calcular las capacidades (tales como el rendimiento, ancho de banda, almacenamiento y acceso) también son estandarizadas.<br><br>
Los niveles de servicio cubren el rendimiento y disponibilidad de la infraestructura virtualizada. El consumidor asume el riesgo operacional que existe por encima de la infraestructura.</p>
                    </div>
                </div><!--/welcome-block-->
            </div><!--/row-fluid-->        
