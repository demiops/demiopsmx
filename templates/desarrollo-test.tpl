...
<div class="container">		
	<div class="row-fluid">
    	<div class="span9">
            <!-- Our Services -->
            <div class="row-fluid">
                <div class="headline"><h3>Desarrollo y Test</h3></div>
                <div class="row-fluid margin-bottom-40">
                    <div class="span12">
                        <h4><a href="#"></a></h4>
                        <p>Clouds publicas y privadas son de gran ayuda en cuanto se refiere a desarrollo y test. La abilidad de proveer a los desarrolladores con sus propios servidores o incluso sus propios ambientes de servidores viene con el beneficio de reducir el tiempo de esfuerzo y administracion para usted y sus desarrolladores. Realizar pruebas de rendimiento utilizando cientos o miles de servidores virtuales los cuales son configurados en menos de unos segundos, le da a su equipo de desarrolladores la habilidad de replicar escenarios reales al mismo tiempo que reducen la complejidad de estos. </p>
                    </div>
                </div><!--/welcome-block-->
            </div><!--/row-fluid-->        
